...
def submit(model, model_name, arg):
    rssrai_val = VOCSegmentation(arg, split='train')
...
def main(arg):
    ...
    model = load_parameter(model
                           , type="pre_model"
                           ,
                           pre_model="/home/arron/Documents/arron/pytorch-deeplab-xception/run/coco/deeplab-resnet/model_best.pth.tar")
    # 输出结果
    submit(model, model_name,arg)
