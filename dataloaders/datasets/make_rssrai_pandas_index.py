...
base_rssrai_path = Path.db_root_dir("rssrai")

base_rssrai_images_path = os.path.join(base_rssrai_path,"img_npy")
base_rssrai_label_path = os.path.join(base_rssrai_path,"label_npy")

images_path_list = glob.glob(os.path.join(base_rssrai_images_path,'*'))
...
#     list = re.split(r"_label_|\.",label_path)
#     new_path = list[0]+"_"+list[1]+"_label.npy"
